...
// in simulator we redefine to format for Dietas100 Developer console
...
{\
	NSString * exceptionName = [@"org.dietas100." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dietas100";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDietas100NativeItemNone = -1, 
	UIDietas100NativeItemSpinner = -2,
	UIDietas100NativeItemProgressBar = -3,
	
	UIDietas100NativeItemSlider = -4,
	UIDietas100NativeItemSwitch = -5,
	UIDietas100NativeItemMultiButton = -6,
	UIDietas100NativeItemSegmented = -7,
	
	UIDietas100NativeItemTextView = -8,
	UIDietas100NativeItemTextField = -9,
	UIDietas100NativeItemSearchBar = -10,
	
	UIDietas100NativeItemPicker = -11,
	UIDietas100NativeItemDatePicker = -12,
	
	UIDietas100NativeItemInfoLight = -13,
	UIDietas100NativeItemInfoDark = -14,
	
	UIDietas100NativeItemDisclosure = -15,
	
	UIDietas100NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Dietas100 instances of

...
/**
 Base class for all Dietas100 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Dietas100 view hierarchy (such as wrapped iOS UIViews) was touched.

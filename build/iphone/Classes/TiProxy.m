...
//Rare exceptions to indicate a bug in the _dietas100 code (Eg, method that a subclass should have implemented)
...
+ (id)createProxy:(NSString*)qualifiedName withProperties:(NSDictionary*)properties inContext:(id<TiEvaluator>)context
{
	...
	if (proxyClass == nil) {
		NSString *_dietas100 = [NSString stringWithFormat:@"%@%s",@"Ti","tanium."];
		if ([qualifiedName hasPrefix:_dietas100]) {
		...
		if (proxyClass==nil) {
			...
			@throw [NSException exceptionWithName:@"org.dietas100.module"

...
/**
 The base class for all Dietas100 modules
 */
...
/**
 Dietas100 Platform calls this method on startup.
 */
-(void)startup;

/**
 Dietas100 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Dietas100 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Dietas100 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Dietas100 Platform calls this method on resume.
 @param sender The sender of the event.
 */

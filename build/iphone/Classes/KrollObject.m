...
//@interface Dietas100Object : NSObject
//@end

@interface Dietas100Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Dietas100Object class]])
		{
			for (NSString *key in [[(Dietas100Object*)o modules] allKeys])
			{
